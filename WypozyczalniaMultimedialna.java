...
public class WypozyczalniaMultimedialna {
    public static void main(String[] args) {
        Ksiazki ksiazka = new Ksiazki("Kategoria zbioru- Ksiazki", 4533, "20.04.2020","Stephen King","WSN",40);
        System.out.println();

        PlytyMuzyczne plytyMuzyczne = new PlytyMuzyczne( "Kategoria zbioru- Plyty muzyczne",283434,"04.05.1990", "Michael Jackson","Sony music", 28);
        System.out.println();
